 ...
 *      - Otherwise             on fail
 */
esp_err_t esp_lcd_new_panel_sn65dsi(const esp_lcd_panel_io_handle_t io, const esp_lcd_panel_dev_config_t *panel_dev_config, esp_lcd_panel_handle_t *ret_panel);

/**
 * @brief MIPI DSI bus configuration structure
 *
 */
#define SN65_PANEL_BUS_DSI_2CH_CONFIG()                \
    {                                                     \
        .bus_id = 0,                                      \
        .num_data_lanes = 2,                              \
        .phy_clk_src = 0,                                 \
 ...
 *
 */
#define SN65_PANEL_IO_DBI_CONFIG() \
    {                                 \
        .virtual_channel = 0,         \
        .lcd_cmd_bits = 8,            \
        .lcd_param_bits = 8,          \
 ...
 *
 */
#define SN65_1280_800_PANEL_60HZ_CONFIG(px_format)            \
    {                                                            \
        .virtual_channel = 0,                                    \
